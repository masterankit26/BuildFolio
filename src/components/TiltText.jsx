...
const TiltText = forwardRef((props, ref) => {
  return (
    <div ref={ref} className='text-right text-white font-serif will-change-transform'>
      <h1 className='text-[3vw] sm:text-2xl md:text-3xl lg:text-4xl uppercase font-bold leading-tight'>
        I'm <span className='text-green-200'>Full Stack</span>
      </h1>
      <h1 className='text-[3vw] sm:text-xl md:text-2xl lg:text-3xl uppercase font-semibold'>
